    ...
    return f.jsxs("div", {
        ...
        children: [f.jsx("div", {
            ...
            children: M === 0 ? f.jsx("div", {
                ...
                style: {
                    backgroundImage: "url('assets/FGGBOGO.png')"
                }
            }) : f.jsx(cm, {})
        }), M === 0 && f.jsx("div", {
            ...
            children: f.jsxs("div", {
                className: "px-3 py-2 flex justify-between items-center border-b border-gray-100",
                    children: [f.jsx("svg", {
                        ...
                        xmlns: "http://www.w3.org/2000/svg",
                        children: f.jsx("path", {
                            d: "M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073c0 6.019 4.388 11.009 10.125 11.927v-8.437H7.078v-3.49h3.047V9.41c0-3.017 1.792-4.687 4.533-4.687 1.313 0 2.686.235 2.686.235v2.962h-1.514c-1.491 0-1.956.926-1.956 1.875v2.278h3.328l-.532 3.49h-2.796V24C19.612 23.082 24 18.092 24 12.073z"
                        })
                    }), f.jsx("span", {
                    ...
                    children: [f.jsxs("div", {
                        ...
                        children: [f.jsx("button", {
                            ...
                            onClick: Et,
                            className: "px-6 py-2 bg-[#1877f2] text-white font-bold rounded hover:bg-[#0c4896] shadow-lg text-sm transition-colors",
